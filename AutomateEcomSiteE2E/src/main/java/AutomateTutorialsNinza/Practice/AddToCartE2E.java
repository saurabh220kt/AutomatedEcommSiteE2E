package AutomateTutorialsNinza.Practice;
...
public class AddToCartE2E {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println(driver.findElement(By.xpath("//ul[@class='breadcrumb']//a[text()=\"Account\"]")).isDisplayed());  //True
		...
		WebElement ele2 = driver
				.findElement(By.xpath("//a[text()=\"HP LP3065\"]//following::a[text()=\"shopping cart\"]"));
